          ...
          <div class="row mt-5">
            ...
            <div class="col-md-4 offset-md-4">
              ...
              <form action="/addData" method="POST" enctype="multipart/form-data" class="mt-3">
                ...
                <input type="phone" class="form-control" id="phone" name="phone" placeholder="Enter Phone"><br>
                <input type="text" class="form-control" id="roll"  name="roll" placeholder="Enter Roll"><br>
                <input type="subject" class="form-control" id="subject" name="subject" placeholder="Enter Subject"><br>
